export default {
  ...
  //Contact Email
  contactEmail: "ann.kemp@scarlet.be",

  // Landing Page Name
  landingPageName: "Ann Kemp",

  // Landing Page Paragraph
  landingPagePara:
    "Designer and front-end developer. I worked as the Creative Director and teacher in Belgium, while also studieng IT-projects that pique my interest.",
  ...
  social: [
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/annkemp/"
    },
    {
      name: "Github",
      url: "https://www.behance.net/AnnKemp"
    },
    {
      name: "Dribbble",
      url: "https://dribbble.com/annkemp"
    }
  ],
